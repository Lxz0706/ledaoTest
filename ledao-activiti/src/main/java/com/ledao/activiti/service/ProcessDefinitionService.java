package com.ledao.activiti.service;
...
public class ProcessDefinitionService {
     ...
     * @return
     */
    public Page<com.ledao.activiti.dao.ProcessDefinition> listProcessDefinition(com.ledao.activiti.dao.ProcessDefinition processDefinition) {
        PageDao pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.ledao.activiti.dao.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            ...
            com.ledao.activiti.dao.ProcessDefinition entity = new com.ledao.activiti.dao.ProcessDefinition();
