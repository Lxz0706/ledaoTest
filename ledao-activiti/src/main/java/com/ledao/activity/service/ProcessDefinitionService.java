...
public class ProcessDefinitionService {
     ...
     * @return
     */
    public Page<com.ledao.activity.dao.ProcessDefinition> listProcessDefinition(com.ledao.activity.dao.ProcessDefinition processDefinition) {
        PageDao pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.ledao.activity.dao.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            ...
            com.ledao.activity.dao.ProcessDefinition entity = new com.ledao.activity.dao.ProcessDefinition();
