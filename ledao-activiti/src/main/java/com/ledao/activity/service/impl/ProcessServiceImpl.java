...
import com.ledao.activity.dao.HistoricActivity;
...
public class ProcessServiceImpl implements IProcessService {
    ...
    public void complete(String taskId, String instanceId, String itemName, String itemContent, String module, Map<String, Object> variables, HttpServletRequest request) {
        ...
        try {
            while (parameterNames.hasMoreElements()) {
                ...
                if (parameterName.startsWith("p_")) {
                    ...
                    if (parameter.length == 3) {
                        ...
                        if ("B".equals(parameter[1])) {
                            value = BooleanUtils.toBoolean(paramValue);
                            agree = (boolean) value;
                        } else if ("DT".equals(parameter[1])) {
                            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm");
                            value = sdf.parse(paramValue);
                        } else if ("COM".equals(parameter[1])) {
                            comment = paramValue;
                        }
            ...
            if (StringUtils.isNotNull(task.getOwner()) && StringUtils.isNotEmpty(task.getOwner())) {
                ...
                if ("RESOLVED".equals(delegationState.toString())) {
                    ...
                    System.out.print("此任務為委派任务，需要相關人員審核");
                    //如果是委托任务需要做处理
