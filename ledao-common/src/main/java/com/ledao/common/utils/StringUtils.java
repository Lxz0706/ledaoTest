...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public static void main(String[] args) {
        String s = "financeManager";
        String[] ss = new String[]{"thbManager", "thbManager2", "thbzz", "thbCommon", "financeManager"};
        System.out.println(inStringIgnoreCase(s, s.split(",")));
    }

    /**
     * 将下划线大写方式命名的转换为驼峰式。如果转换前的下划线大写方式命名的字符串为空，则返回空字符串。 例如：HELLO_WORLD->HelloWorld
     *
    ...
    public static String subString(String str, String strStart, boolean lastStart, String strEnd, boolean lastEnd) {

        /* 找出指定的2个字符在 该字符串里面的 位置 */
        int strStartIndex;
        if (lastStart) {
            strStartIndex = str.lastIndexOf(strStart);
        } else {
