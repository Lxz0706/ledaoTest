...
import com.ledao.activiti.dao.ProcessDefinition;
import com.ledao.activiti.service.ProcessDefinitionService;
    ...
    public AjaxResult upload(@RequestParam("processDefinition") MultipartFile file) {
        try {
            if (!file.isEmpty()) {
                ...
                String fileName = FileUploadUtils.upload(Global.getProfile() + "/processDefiniton", file, true);
